// Déclaration du package contenant le DTO pour la réponse d'une classe
...
public class ClasseResponse {
    ...
    // filiere : DTO représentant la filière à laquelle la classe appartient (avec toutes ses données pertinentes)
